...
def print_run_config(args):
    print(
        ...
        f"text_kd_mode={args.text_kd_mode}, "
        f"text_kd_topk={args.text_kd_topk}, "
        f"text_kd_margin={args.text_kd_margin}"
    )
    print(
        "[Run] "
...
if __name__ == "__main__":
    ...
    parser.add_argument('--joint_teacher_adapter', action='store_true', default=False,
    ...
    parser.add_argument('--lambda_text_kd', type=float, default=0.0,
                        help='Trọng số top-k text relation KD.')
    parser.add_argument('--text_kd_mode', type=str, default='none',
                        choices=['none', 'topk_sketch', 'topk_photo', 'topk_both'],
                        help='Chọn nhánh top-k text KD.')
    parser.add_argument('--text_kd_topk', type=int, default=5,
                        help='Số semantic neighbors lấy từ teacher text.')
    parser.add_argument('--text_kd_margin', type=float, default=0.05,
                        help='Margin ranking cho top-k text KD.')
